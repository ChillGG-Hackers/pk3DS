...
namespace pk3DS
{
    public partial class PersonalEditor6 : Form
    {
        ...
        */
        ...
        {
            if (WinFormsUtil.Prompt(MessageBoxButtons.YesNo, "Randomize all? This will also randomize Move Power and Acc. Cannot undo.", "Double check Randomization settings in the Enhancements tab.") != DialogResult.Yes) return;
            saveEntry();
